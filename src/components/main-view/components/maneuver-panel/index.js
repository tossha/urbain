        ...
        <div className="maneuver-panel__content">
            ...
            <div className="panel__field-set">
                ...
                <div className="panel__field">
                    <span className="panel__field-label-small" id="increment" />
                    <div className="maneuver-panel__button-block">
                        <button className="maneuver-panel__button" type="button" id="incr001">
                            0.01
                        </button>
                        <button className="maneuver-panel__button" type="button" id="incr01">
                            0.1
                        </button>
                        <button className="maneuver-panel__button" type="button" id="incr1">
                            1
                        </button>
                        <button className="maneuver-panel__button" type="button" id="incr10">
                            10
                        </button>
                        <button className="maneuver-panel__button" type="button" id="incr100">
                            100
                        </button>
                        <button className="maneuver-panel__button" type="button" id="incr1000">
                            1000
                        </button>
                    </div>
                </div>
            ...
            <div className="panel__field-set">
                ...
                <div className="panel__field">
                    ...
                    <div className="maneuver-panel__button-block">
                        <button className="maneuver-panel__button" type="button" id="epoch-minus">
                            -
                        </button>
                        <button className="maneuver-panel__button" type="button" id="epoch-plus">
                            +
                        </button>
                    </div>
                </div>
            ...
            <div className="panel__field-set">
                ...
                <div className="panel__field">
                    ...
                    <div className="maneuver-panel__button-block">
                        <button className="maneuver-panel__button" type="button" id="prograde-zero">
                            0
                        </button>
                        <button className="maneuver-panel__button" type="button" id="prograde-minus">
                            -
                        </button>
                        <button className="maneuver-panel__button" type="button" id="prograde-plus">
                            +
                        </button>
                    </div>
                </div>
                <div className="panel__field">
                    ...
                    <span className="metrics-panel__dimension">m/s</span>
                    <div className="maneuver-panel__button-block">
                        <button className="maneuver-panel__button" type="button" id="normal-zero">
                            0
                        </button>
                        <button className="maneuver-panel__button" type="button" id="normal-minus">
                            -
                        </button>
                        <button className="maneuver-panel__button" type="button" id="normal-plus">
                            +
                        </button>
                    </div>
                </div>
                <div className="panel__field">
                    ...
                    <span className="metrics-panel__dimension">m/s</span>
                    <div className="maneuver-panel__button-block">
                        <button className="maneuver-panel__button" type="button" id="radial-zero">
                            0
                        </button>
                        <button className="maneuver-panel__button" type="button" id="radial-minus">
                            -
                        </button>
                        <button className="maneuver-panel__button" type="button" id="radial-plus">
                            +
                        </button>
                    </div>
                </div>
